...
<body>
<form action="sessions1order.php" method="post">
<?php 
print_r($_SESSION);
if( isset($_SESSION['sample_hidden']) ) echo 'sample_hidden in SESSION is set.<br/>';
else echo 'sample_hidden in SESSION is NOT set.<br/>';
...
//  session_register('product'); session_register('quantity');
